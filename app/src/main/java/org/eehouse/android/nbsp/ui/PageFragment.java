...
import org.eehouse.android.libs.apkupgrader.Updater;
        ...
        if ( button != null ) {
            button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        String channelID = MainActivity.makeChannelID( context );

                        Updater.run( context, BuildConfig.APPLICATION_ID,
                                     BuildConfig.VERSION_CODE,
                                     BuildConfig.BUILD_TYPE,
                                     BuildConfig.FLAVOR,
                                     channelID, R.mipmap.ic_launcher_round );
                    }
                } );
        }
